...
import { RegistroParticipantesComponent } from './registroparticipantes/registroparticipantes.component';
...
const routes: Routes = [
  { path: '', redirectTo: '/registro-participante', pathMatch: 'full' },
  { path: 'registroparticipantes', component: RegistroParticipantesComponent },
